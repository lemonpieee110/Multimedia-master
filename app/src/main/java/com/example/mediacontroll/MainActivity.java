package com.example.mediacontroll;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String frameVideo = "<p>video from Youtube</p><br><html><body><iframe width=\"300\" height=\"200\" src = \"https://www.youtube.com/embed/YWN81V7ojOE\" frameborder=\"0\"></iframe></body></html>";
        WebView myWebView = (WebView) findViewById(R.id.webview);
        WebSettings webSettings = myWebView.getSettings();
        webSettings.setJavaScriptEnabled(true);
        myWebView.loadData(frameVideo,"text/html","utf-8");
        //myWebView.loadUrl("https://www.youtube.com/watch?v=YWN81V7ojOE");
